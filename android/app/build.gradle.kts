...
android {
    namespace = "com.ketotracker"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.ketotracker"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0-native-demo"
...
dependencies {
    ...
    // Room — JSON-column approach (no migrations needed when DayEntry fields change)
